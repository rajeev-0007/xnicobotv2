...
async function handleDropRates(reply, guildId) {
    ...
    addTextDisplay(container, [
        ...
        `> ${AE.present} **Free Rolls:** ${animeManager.DAILY_FREE_ROLLS}/day (via \`adaily\`)`,
        `> ${AE.fire} **Vote Bonus:** +${animeManager.VOTE_BONUS_ROLLS} rolls per vote when daily rolls run out`,
