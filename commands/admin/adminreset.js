        ...
        try {
            ...
            const confirmContainer = new ContainerBuilder()
                ...
                .addTextDisplayComponents(new TextDisplayBuilder().setContent(
                    `# <:Infotriangle:1521227710381428926> Confirm: Reset Admin List\n\n` +
                    ...
                    `### What will happen:\n` +
                    `- <:Caretright:1521227704953864202> **All** entries will be removed from the admin trust list\n` +
                    `- <:Caretright:1521227704953864202> The **Trusted Admin** role will be revoked from all members\n` +
            ...
            await trust.withConfirmation(message, confirmContainer, async (i) => {
                ...
                for (const entry of userEntries) {
                    await trust.notifyUser(message.client, entry.id,
                        `<:Notificationon:1521227730304106680> The **Admin trust list** in **${message.guild.name}** has been **reset** by **${message.author.username}**.\n> Your admin-level access and Trusted Admin role have been revoked.`
                    );
                }
                ...
                const success = new ContainerBuilder()
                    ...
                    .addTextDisplayComponents(new TextDisplayBuilder().setContent(
                        `# <:Checkedbox:1521227734943269077> Admin List Reset Successfully\n\n` +
                        ...
                        `<:Caretright:1521227704953864202> All admin privileges have been revoked.`
                    ))
;
